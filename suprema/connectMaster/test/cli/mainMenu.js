...
async function searchDevice() {
  ...
  try {
    var devList = await connectMaster.searchDevice(gatewayID, SEARCH_TIMEOUT)

    console.log(`***** Found devices: ${devList.length}`);
    menu.printList(devList);
  } catch (err) {
...
module.exports.setGatewayID = setGatewayID;
module.exports.getGatewayID = getGatewayID;
