...
async function setConnectionMode() {
  ...
  try {
    await connectMaster.setConnectionMode(deviceIDs, mode);
  } catch (err) {
...
async function enableSSL() {
  ...
  try {
    await connectMaster.enableSSL(deviceIDs);
  } catch (err) {
...
async function disableSSL() {
  ...
  try {
    await connectMaster.disableSSL(deviceIDs);
  } catch (err) {
...
async function disconnectAll() {
  ...
  try {
    await connectMaster.disconnectAll(mainMenu.getGatewayID());
  } catch (err) {
